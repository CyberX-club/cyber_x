class GoogleDriveUtils {
    static extractFileId(link) {
        ...
        const pattern = /(?:\/d\/|id=|\/file\/d\/|\/open\?id=|\/uc\?id=|\/view\?id=)([\w-]{25,})/;
...
// Example usage:
try {
    const fileId = GoogleDriveUtils.extractFileId('https://drive.google.com/file/d/1A2B3C4D5E6F7G8H9I0J/view?usp=sharing');
