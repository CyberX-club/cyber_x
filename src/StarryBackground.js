...
const StarryBackground = () => {
    ...
    useEffect(() => {
        ...
        class Star {
            ...
            update() {
                this.color.intensity = Math.sin(Date.now() * 0.001 + this.x + this.y) * 0.2 + 0.8;
            }
        }
        ...
        class Meteor {
            ...
            draw() {
                ...
                this.trail.forEach((pos, index) => {
                    const trailOpacity = (this.trail.length - index) / this.trail.length * this.opacity * 0.5;
        ...
        const meteors = Array(2).fill().map(() => new Meteor());
