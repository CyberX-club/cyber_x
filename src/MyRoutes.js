...
const MyRoutes = () => {
  ...
  const vpCyberSecurityInterviewData = {
    title: "Vice Principal's Message",
    subtitle: "Perspectives on Cybersecurity & Student Safety",
    imageSrc: "https://i.imgur.com/U0vkjPk.jpeg", // Placeholder image for VP's photo
    questions: [
      "The Indian culture has always had deep roots with concepts such as \"prevention is better than cure.\" Do you believe it's essential to apply this to cybersecurity today? How can we do so?",
      
      "In today's world, how do you see the importance of cyber awareness?",
      
      "How can we engage more students in cybersecurity, especially those who don't know much about it?",
      
      "With hacking and cyberbullying on the rise, what can school students do to create a safer online environment?",
      
      "With cybersecurity threats on the rise, how should students approach digital security to protect student and staff information?"
    ],
    answers: [
